                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="divide-y divide-gray-200">
                            <form wire:submit.prevent="login" class="py-8 text-base leading-6 space-y-6 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                {{-- Password --}}
                                <div class="relative">
                                    <input wire:model.lazy="User_Password" id="User_Password" name="User_Password" type="password"
                                    ...
                                    @error('User_Password') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                                </div>
