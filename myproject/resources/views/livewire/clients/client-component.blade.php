    ...
    <div class="bg-white shadow-sm border-b border-gray-200 bg-indigo-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Gestión de Clientes</h1>
                    <nav class="flex items-center text-sm text-gray-600 mt-1">
                        ...
                        <span class="text-indigo-600 font-medium">Clientes</span>
                    </nav>
                </div>
                <button 
                    wire:click="$dispatch('openCreateClientModal')"
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-white-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">En la siguiente tabla puede observar la lista de clientes</p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                        ...
                        <button 
                            ...
                            onclick="document.getElementById('searchClient').value = ''"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a href="tel:{{ $client->Client_Phone }}" class="hover:text-indigo-600 hover:underline">
                                    {{ $client->Client_Phone }}
                                </a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <a href="mailto:{{ $client->Client_Email }}" class="hover:text-indigo-600 hover:underline">
                                    {{ $client->Client_Email }}
                                </a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    ...
                                    <button 
                                        ...
                                        wire:click="$dispatch('showDeleteModal', {Client_ID: '{{ $client->Client_ID }}'})"
                                        title="Eliminar"
                                    >
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
