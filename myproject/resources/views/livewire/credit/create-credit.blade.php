<div id="form" class="max-w-full px-8 mx-auto p-6 bg-white rounded-xl shadow-lg border border-gray-200">
    ...
    <option value="6">6 meses</option>
        ...
        <!-- Sección Productos -->
        <div class="space-y-4">
            <div class="flex justify-between items-cen<div id="form" class="max-w-full px-8 mx-auto p-6 bg-white rounded-xl shadow-lg border border-gray-200">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-3">Crear Nuevo Crédito</h2>
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-50 p-4 rounded-lg">
            ...
            <div class="flex items-end">
             <button type="button" wire:click="cancelTransaction" onclick="
    document.getElementById('client_id').value = '';
    document.getElementById('term').value = '';
    document.getElementById('payment_type_id').value = '';

    @this.set('creditDetails', []);
    @this.set('totalWithInterest', 0);
    @this.set('quotaAmount', 0);
