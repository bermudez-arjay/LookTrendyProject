        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative rounded-md shadow-sm">
                    <input id="searchInventory" wire:model.live.debounce.200ms="keyWord" type="text"
            ...
            <div class="flex items-end space-x-2">
                ...
                <div class="flex space-x-2 mb-1">
                    <button wire:click="exportAllExcel" wire:loading.attr="disabled"
                    ...
                    <button wire:click="exportAllPdf" wire:loading.attr="disabled"
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex space-x-2">
                                <button wire:click="exportLowStockExcel" wire:loading.attr="disabled"
                                    class="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded text-sm flex items-center transition-colors">
                                    <i class="fas fa-file-excel mr-2"></i>
                                ...
                                <button wire:click="exportLowStockPdf" wire:loading.attr="disabled"
                                    class="bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded text-sm flex items-center transition-colors">
                                    <i class="fas fa-file-pdf mr-2"></i>
