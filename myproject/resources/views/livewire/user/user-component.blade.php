<div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 w-full">
    <!-- Encabezado -->
    <div class="bg-white shadow-sm border-b border-gray-200 w-full">
        <div class="px-4 sm:px-6 lg:px-8 py-4 w-full">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <nav class="flex items-center text-sm text-gray-600 mt-1">
                        ...
                        <span class="text-indigo-600 font-medium">Gestión de usuarios</span>
                    </nav>
                </div>
                <button wire:click="$dispatch('openCreateUserModal')"
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-white-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">En la siguiente tabla puede observar la lista de usuarios</p>
                    </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <button
                                            wire:click="$dispatch('editUserByEmail', { email: '{{ $user->User_Email }}' })"
                                        ...
                                        <button
                                            ...
                                            wire:click="$dispatch('showDeleteModal', {User_ID: '{{ $user->User_ID }}'})"
                                            title="Eliminar">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
