<div >
    <div class="mt-[-35px]">
        <h1 class="text-2xl font-extrabold text-gray-900 mb-1">Gestión de Usuarios</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200 bg-white shadow-md rounded-lg">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($users as $user)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $user->User_FirstName }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $user->User_LastName }}</td>
